...
$string['alreadyincart'] = 'That course is already in your cart.';
$string['cart_empty'] = 'Your cart is empty.';
$string['cart_title'] = 'Shopping cart';
$string['catalogue'] = 'Course store';
$string['catalogue_all'] = 'All courses';
$string['catalogue_categories'] = 'Filter by category';
$string['catalogue_empty'] = 'No courses are available in the store at this time.';
$string['categories_none'] = 'No categories have been created yet.';
$string['categories_title'] = 'Manage categories';
$string['category_add'] = 'Add category';
$string['category_delete_confirm'] = 'Are you sure you want to delete this category? Products will become uncategorised.';
...
$string['email_order_receipt_body'] = 'Thank you for your purchase. Your order #{$a->orderid} totalling {$a->cost} has been confirmed. View your receipt and access your enrolled courses: {$a->receipturl}';
$string['email_order_receipt_subject'] = 'Your EduCheckout order #{$a} is confirmed';
$string['error_categorynamerequired'] = 'A category name is required.';
$string['error_invalidsessionendtime'] = 'Session end time must be after the start time.';
$string['error_invalidsessionstarttime'] = 'Session start time is required.';
$string['error_negativeduration'] = 'Duration cannot be negative.';
$string['error_negativeprice'] = 'Price cannot be negative.';
$string['free'] = 'Free';
$string['gateway_fee_default_label'] = 'Card processing fee';
$string['gateway_fee_enable'] = 'Enable card processing fee';
$string['gateway_fee_enable_desc'] = 'Add a payment-gateway surcharge to the order total at checkout. The surcharge is included in the amount sent to the payment gateway.';
$string['gateway_fee_fixed'] = 'Card processing fee (fixed)';
$string['gateway_fee_fixed_desc'] = 'Fixed amount added to every order in the configured currency (for example 0.30).';
$string['gateway_fee_label'] = 'Card processing fee label';
$string['gateway_fee_label_desc'] = 'Label shown on the checkout summary and receipt for the gateway surcharge.';
$string['gateway_fee_percent'] = 'Card processing fee (%)';
$string['gateway_fee_percent_desc'] = 'Percentage of subtotal plus tax added to the order total (for example 1.75).';
...
$string['order_course_missing'] = '(course no longer available)';
...
$string['orders_all'] = 'All';
$string['orders_amount'] = 'Amount';
$string['orders_courses'] = 'Course(s)';
$string['orders_date'] = 'Date';
$string['orders_none'] = 'No orders found.';
$string['orders_receipt'] = 'Receipt';
$string['orders_status'] = 'Status';
$string['orders_student'] = 'Student';
$string['orders_title'] = 'Order management';
...
$string['pagination_label'] = 'Catalogue pages';
$string['pay'] = 'Pay now';
...
$string['product_course'] = 'Course';
$string['product_delete_confirm'] = 'Are you sure you want to delete this product? This cannot be undone.';
$string['product_description'] = 'Description';
$string['product_disable'] = 'Disable';
$string['product_edit_title'] = 'Edit product';
$string['product_enable'] = 'Enable';
$string['product_enabled'] = 'Enabled';
$string['product_enabled_no'] = 'Disabled';
$string['product_enabled_yes'] = 'Enabled';
$string['product_image'] = 'Product image';
$string['product_saved'] = 'Product saved.';
$string['product_sortorder'] = 'Sort order';
$string['product_status'] = 'Status';
$string['product_tags'] = 'Tags';
$string['product_tags_help'] = 'Enter comma-separated tags to help students find this course, e.g. <em>compliance, induction, safety</em>.';
$string['product_type'] = 'Product type';
$string['product_type_session'] = 'Session (scheduled delivery)';
...
$string['reports_col_category'] = 'Category';
$string['reports_col_price'] = 'Price';
$string['reports_col_product'] = 'Product';
$string['reports_col_variation'] = 'Variation';
$string['reports_csv_category'] = 'Category';
$string['reports_csv_currency'] = 'Currency';
$string['reports_csv_date'] = 'Date';
$string['reports_csv_orderid'] = 'Order ID';
$string['reports_csv_price'] = 'Price';
$string['reports_csv_product'] = 'Product';
$string['reports_csv_productid'] = 'Product ID';
$string['reports_csv_status'] = 'Status';
$string['reports_csv_student'] = 'Student';
$string['reports_csv_tax'] = 'Tax';
$string['reports_csv_unitprice'] = 'Unit price';
$string['reports_csv_variation'] = 'Variation';
$string['reports_csv_variationid'] = 'Variation ID';
$string['reports_download_pricelist'] = 'Download price list (CSV)';
$string['reports_download_sales'] = 'Download sales (CSV)';
$string['reports_from'] = 'From';
$string['reports_kpi_aov'] = 'Average order value';
$string['reports_kpi_orders'] = 'Orders';
$string['reports_kpi_revenue'] = 'Revenue';
$string['reports_kpi_units'] = 'Units sold';
$string['reports_no_products'] = 'No products have been published yet.';
$string['reports_no_sales'] = 'No completed sales fall within the selected range.';
$string['reports_price_list'] = 'Price list';
$string['reports_range_label'] = 'Reporting on:';
$string['reports_revenue'] = 'Revenue';
$string['reports_title'] = 'Sales reports';
$string['reports_to'] = 'To';
$string['reports_top_products'] = 'Best performing products';
$string['reports_trend'] = 'Monthly sales trend';
$string['reports_units_sold'] = 'Units sold';
$string['selectvariation'] = 'Choose an option';
$string['session_capacity'] = 'Capacity';
$string['session_capacity_help'] = 'Maximum number of seats available. Enter 0 for unlimited.';
$string['session_endtime'] = 'End date/time';
$string['session_full'] = 'This session is full.';
$string['session_location'] = 'Location';
$string['session_seats_remaining'] = '{$a} seats remaining';
$string['session_seats_unlimited'] = 'Unlimited seats';
$string['session_starttime'] = 'Start date/time';
$string['sessions_heading'] = 'Sessions';
...
$string['variation'] = 'Option';
$string['variation_add'] = 'Add variation';
$string['variation_delete_confirm'] = 'Are you sure you want to delete this variation?';
$string['variation_duration'] = 'Duration (days)';
$string['variation_duration_help'] = 'Number of days the enrolment lasts. Enter 0 for no expiry.';
$string['variation_edit'] = 'Edit variation';
$string['variation_enabled'] = 'Enabled';
$string['variation_name'] = 'Name';
$string['variation_price'] = 'Price';
$string['variation_session_capacity'] = 'Capacity';
$string['variation_session_endtime'] = 'End date/time';
$string['variation_session_location'] = 'Location';
$string['variation_session_starttime'] = 'Start date/time';
$string['variations_heading'] = 'Pricing options (variations)';
$string['variations_none'] = 'No variations yet. Add one below.';
